...
function collection (target, pSubs, subs, update, tree, stamp, rTree, rSubs, force) {
  // if (subs === true) {
  //   // lets see why this is nessecary make stuff heavier for no reason at all?
  //   pSubs.$any = subs = { val: true }
  // }
...
function generateStamp (target, tree, stamp, rTree, rSubs) {
  ...
  // this is a piece of shit -- should fire for new -- it does do a set and everything???
  return lstamp
}

// we need this since you can have things that dont emit (empty objects for example)
// function resolveStamps (target) {
//   var t = target._parent
//   while (t) {
//     if (t._lstamp) {
//       target._lstamp = t._lstamp
//       t = null
//     } else {
//       t = t._parent
//     }
